...
class Message:
    ...
    def __init__(self, sender, content):
        ...
        Message.message_counter +=1 # Increase counter for next message

    def __str__(self): # this defines how obj print
...
class ChatRoom:
   ...
   def broadcast(self, sender, content):
      ...
      print(message) # show message to all user
